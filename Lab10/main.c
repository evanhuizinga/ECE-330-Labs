...
char GREEN_STEP = 2;
char BLUE_STEP = 3;
char DIM_Enable = 1; // Enable LED dimming
...
int main(void)
{
  ...
  *******************************************************************************************************/
  ...
  while (1)
  {
	  // Commented out Question 1 & 2 Code //
	  ...
	  RED_BRT = redValue >> 4; // Read redValue to red brightness
	  BLUE_BRT = blueValue >> 4; // Read blueValue to blue brightness
	  GREEN_BRT = greenValue >> 4; // Read greenValue to green brightness
