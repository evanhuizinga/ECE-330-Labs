...
int CRC_Tx = 0x8aebaffc; // Altered value to match CRC_Rx value corresponding to updated message value //
int CRC_Rx = 0;

/* HELLO ECE-330L */
char Message[] =
		{SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,
		CHAR_R,CHAR_I,CHAR_V,CHAR_E,CHAR_R,SPACE,CHAR_C,CHAR_O,CHAR_M,CHAR_P,CHAR_U,CHAR_T,CHAR_E,CHAR_R,
		SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE};
	// Changed message to River Computer //
